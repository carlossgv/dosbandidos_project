...
from accounting.utils.utils_csv_handling import (
    csv_create_expense,
    format_date,
    load_csv_expenses,
    load_csv_incomes,
...
class CsvReading(TestCase):
    ...
    def test_create_expense_by_row_if_description_contains_a_rule(self):
        row = [
            ...
            "8/6/2021",
            "",
            "ACH Debit - ACH Bill.com   Superior Linen - Dos Bandidos - Broken",
            "97.50",
            "",
            "Posted",
            "",
